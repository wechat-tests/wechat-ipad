...
namespace micromsg
{
	...
	public class BizAppInfo : IExtensible
	{
		...
		private uint _AppUpdateVersion = 0u;
		...
		[ProtoMember(16, IsRequired = true, Name = "AppInfoFlag", DataFormat = DataFormat.TwosComplement)]
		...
		[ProtoMember(17, IsRequired = true, Name = "AppVersion", DataFormat = DataFormat.TwosComplement)]
		...
		[ProtoMember(18, IsRequired = false, Name = "AppUpdateVersion", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
		...
		[ProtoMember(19, IsRequired = false, Name = "IconUrlMDPI", DataFormat = DataFormat.Default), DefaultValue("")]
		...
		[ProtoMember(21, IsRequired = false, Name = "DownloadUrlMd5", DataFormat = DataFormat.Default), DefaultValue("")]
		...
		[ProtoMember(22, IsRequired = false, Name = "GooglePlayDownloadUrl", DataFormat = DataFormat.Default), DefaultValue("")]
