...
namespace micromsg
{
	[ProtoContract(Name = "SearchContactResponse")]
	[Serializable]
	public class SearchContactResponse : IExtensible
	{
		...
		[ProtoMember(11, IsRequired = false, Name = "PersonalCard", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
		...
		[ProtoMember(12, IsRequired = false, Name = "VerifyFlag", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
		...
		[ProtoMember(16, IsRequired = false, Name = "WeiboNickname", DataFormat = DataFormat.Default), DefaultValue("")]
		...
		[ProtoMember(17, IsRequired = false, Name = "WeiboFlag", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
		...
		[ProtoMember(18, IsRequired = false, Name = "AlbumStyle", DataFormat = DataFormat.TwosComplement), DefaultValue(0)]
		...
		[ProtoMember(19, IsRequired = false, Name = "AlbumFlag", DataFormat = DataFormat.TwosComplement), DefaultValue(0)]
		...
		[ProtoMember(21, IsRequired = false, Name = "SnsUserInfo", DataFormat = DataFormat.Default), DefaultValue(null)]
		...
		[ProtoMember(22, IsRequired = false, Name = "Country", DataFormat = DataFormat.Default), DefaultValue("")]
		...
		[ProtoMember(23, IsRequired = false, Name = "MyBrandList", DataFormat = DataFormat.Default), DefaultValue("")]
		...
		[ProtoMember(24, IsRequired = false, Name = "CustomizedInfo", DataFormat = DataFormat.Default), DefaultValue(null)]
		...
		[ProtoMember(25, IsRequired = false, Name = "ContactCount", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
		...
		[ProtoMember(26, Name = "ContactList", DataFormat = DataFormat.Default)]
		...
		[ProtoMember(27, IsRequired = false, Name = "BigHeadImgUrl", DataFormat = DataFormat.Default), DefaultValue("")]
		...
		[ProtoMember(28, IsRequired = false, Name = "SmallHeadImgUrl", DataFormat = DataFormat.Default), DefaultValue("")]
		...
		[ProtoMember(29, IsRequired = false, Name = "ResBuf", DataFormat = DataFormat.Default), DefaultValue(null)]
		...
		[ProtoMember(31, IsRequired = false, Name = "KFWorkerID", DataFormat = DataFormat.Default), DefaultValue("")]
		...
		[ProtoMember(32, IsRequired = false, Name = "MatchType", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
