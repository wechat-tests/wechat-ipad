...
namespace micromsg
{
	[ProtoContract(Name = "VerifyPswdRequest")]
	[Serializable]
	public class VerifyPswdRequest : IExtensible
	{
		...
		[ProtoMember(5, IsRequired = false, Name = "ImgSid", DataFormat = DataFormat.Default), DefaultValue(null)]
		...
		[ProtoMember(6, IsRequired = false, Name = "ImgCode", DataFormat = DataFormat.Default), DefaultValue(null)]
		...
		[ProtoMember(7, IsRequired = false, Name = "ImgEncryptKey", DataFormat = DataFormat.Default), DefaultValue(null)]
		...
		[ProtoMember(8, IsRequired = false, Name = "KSid", DataFormat = DataFormat.Default), DefaultValue(null)]
		...
		[ProtoMember(9, IsRequired = false, Name = "Scence", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
		public uint Scence
		{
			get
			{
		...
		[ProtoMember(10, IsRequired = false, Name = "WTLoginReqBuff", DataFormat = DataFormat.Default), DefaultValue(null)]
