...
namespace micromsg
{
	[ProtoContract(Name = "VoipAnswerResp")]
	[Serializable]
	public class VoipAnswerResp : IExtensible
	{
		...
		[ProtoMember(16, IsRequired = false, Name = "TcpCnt", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
		public uint TcpCnt
		{
			get
			{
		...
		[ProtoMember(17, IsRequired = false, Name = "SwitchInterval", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
		...
		[ProtoMember(18, IsRequired = false, Name = "Hw264SvrCfg", DataFormat = DataFormat.TwosComplement), DefaultValue(0)]
		...
		[ProtoMember(19, IsRequired = false, Name = "AudioEnableRmioAndS3A", DataFormat = DataFormat.TwosComplement), DefaultValue(0)]
