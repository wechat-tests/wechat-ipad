...
namespace micromsg
{
	[ProtoContract(Name = "SnsCommentInfo")]
	[Serializable]
	public class SnsCommentInfo : IExtensible
	{
		...
		private ulong _ReplyCommentId2 = 0uL;

		private ulong _CommentId2 = 0uL;
		...
		[ProtoMember(10, IsRequired = false, Name = "IsNotRichText", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
		...
		[ProtoMember(11, IsRequired = false, Name = "ReplyCommentId2", DataFormat = DataFormat.TwosComplement), DefaultValue(0f)]
		...
		[ProtoMember(12, IsRequired = false, Name = "CommentId2", DataFormat = DataFormat.TwosComplement), DefaultValue(0f)]
		...
		[ProtoMember(13, IsRequired = false, Name = "DeleteFlag", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
