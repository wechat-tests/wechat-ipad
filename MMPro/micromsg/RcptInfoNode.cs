...
namespace micromsg
{
	[ProtoContract(Name = "RcptInfoNode")]
	[Serializable]
	public class RcptInfoNode : IExtensible
	{
		...
		[ProtoMember(2, IsRequired = false, Name = "country", DataFormat = DataFormat.Default), DefaultValue(null)]
		...
		[ProtoMember(10, IsRequired = false, Name = "nationalcode_gbt2260", DataFormat = DataFormat.Default), DefaultValue(null)]
