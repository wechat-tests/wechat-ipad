...
namespace micromsg
{
	...
	public class VoipAckReq : IExtensible
	{
		...
		[ProtoMember(6, IsRequired = false, Name = "PeerId", DataFormat = DataFormat.Default), DefaultValue(null)]
		...
		[ProtoMember(7, IsRequired = false, Name = "CapInfo", DataFormat = DataFormat.Default), DefaultValue(null)]
		...
		[ProtoMember(11, IsRequired = false, Name = "Timestamp64", DataFormat = DataFormat.TwosComplement), DefaultValue(0f)]
