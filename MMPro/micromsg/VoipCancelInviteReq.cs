...
namespace micromsg
{
	[ProtoContract(Name = "VoipCancelInviteReq")]
	[Serializable]
	public class VoipCancelInviteReq : IExtensible
	{
		...
		[ProtoMember(10, IsRequired = false, Name = "Timestamp64", DataFormat = DataFormat.TwosComplement), DefaultValue(0f)]
		...
		[ProtoMember(11, IsRequired = false, Name = "InviteId", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
