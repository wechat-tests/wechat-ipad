...
namespace micromsg
{
	[ProtoContract(Name = "LbsContactInfo")]
	[Serializable]
	public class LbsContactInfo : IExtensible
	{
		...
		[ProtoMember(9, IsRequired = false, Name = "VerifyFlag", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
		...
		[ProtoMember(15, IsRequired = false, Name = "WeiboFlag", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
		...
		[ProtoMember(19, IsRequired = false, Name = "HeadImgVersion", DataFormat = DataFormat.TwosComplement), DefaultValue(0)]
		...
		[ProtoMember(22, IsRequired = false, Name = "BigHeadImgUrl", DataFormat = DataFormat.Default), DefaultValue("")]
		...
		[ProtoMember(23, IsRequired = false, Name = "SmallHeadImgUrl", DataFormat = DataFormat.Default), DefaultValue("")]
		...
		[ProtoMember(24, IsRequired = false, Name = "MyBrandList", DataFormat = DataFormat.Default), DefaultValue("")]
		...
		[ProtoMember(25, IsRequired = false, Name = "CustomizedInfo", DataFormat = DataFormat.Default), DefaultValue(null)]
