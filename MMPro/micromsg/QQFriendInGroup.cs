...
namespace micromsg
{
	[ProtoContract(Name = "QQFriendInGroup")]
	[Serializable]
	public class QQFriendInGroup : IExtensible
	{
		...
		[ProtoMember(13, IsRequired = false, Name = "AlbumFlag", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
		...
		[ProtoMember(14, IsRequired = false, Name = "AlbumStyle", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
		...
		[ProtoMember(16, IsRequired = false, Name = "SnsUserInfo", DataFormat = DataFormat.Default), DefaultValue(null)]
		...
		[ProtoMember(17, IsRequired = false, Name = "Country", DataFormat = DataFormat.Default), DefaultValue("")]
		...
		[ProtoMember(18, IsRequired = false, Name = "MyBrandList", DataFormat = DataFormat.Default), DefaultValue("")]
		...
		[ProtoMember(19, IsRequired = false, Name = "CustomizedInfo", DataFormat = DataFormat.Default), DefaultValue(null)]
