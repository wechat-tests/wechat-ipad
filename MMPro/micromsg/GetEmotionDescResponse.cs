...
namespace micromsg
{
	[ProtoContract(Name = "GetEmotionDescResponse")]
	[Serializable]
	public class GetEmotionDescResponse : IExtensible
	{
		...
		[ProtoMember(6, IsRequired = false, Name = "DownLoadFlag", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
