...
namespace micromsg
{
	[ProtoContract(Name = "BaseResponseErrMsg")]
	[Serializable]
	public class BaseResponseErrMsg : IExtensible
	{
		...
		[ProtoMember(8, IsRequired = false, Name = "Countdown", DataFormat = DataFormat.TwosComplement), DefaultValue(0L)]
